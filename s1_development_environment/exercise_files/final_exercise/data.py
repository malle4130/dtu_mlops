...
DATA_PATH = "/home/malenka/DTU/dtu_mlops/data/corruptmnist/corruptmnist_v1"

def corrupt_mnist() -> tuple[torch.utils.data.TensorDataset, torch.utils.data.TensorDataset]:
    ...
    trainloader = torch.utils.data.TensorDataset(train_images, train_target)
    testloader = torch.utils.data.TensorDataset(test_images, test_target)
